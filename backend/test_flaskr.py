...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_422_if_new_question_has_wrong_category(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(
            data['message'], 'Unprocessable Entity, check your request')
    ...
    def test_delete_question(self):
        ...
        new_question_id = Question.query.order_by(
    ...
    def test_400_fail_delete_book_doesnt_exist(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(
            data['message'], 'Bad request, server couldnt understand it')
    ...
    def test_quiz_get_Science_question(self):
        ...
        res = self.client().post('/quizzes', json={
            ...
            # can be id of any category questions
